        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative z-10 p-2">
          {features.map((feature, idx) => (
            ...
            >
              ...
              <div className={`w-14 h-14 rounded-xl flex items-center justify-center mb-8 transition-all duration-300 ${
                feature.id === 'books-validation' ? 'bg-emerald-50 text-emerald-600 group-hover:bg-emerald-500 group-hover:text-white' : 
