        ...
        <div className="flex flex-col items-center justify-center h-full min-h-[600px] bg-stone-50/50">
            <div className="text-center space-y-6 max-w-sm">
                ...
                <div className="p-4 bg-stone-100 border border-stone-200 rounded-xl flex items-start gap-3 text-left">
                    ...
                    <div>
                        <div className="text-sm font-bold text-stone-800">SQLite Integration Pending</div>
                        <div className="text-xs text-stone-500 mt-1">This module will be fully activated in the Phase 2 rollout.</div>
                    </div>
                </div>
            </div>
        </div>
